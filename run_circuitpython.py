"""Example runner for CircuitPython/neopixel (or Blinka + neopixel).

This script is intended to be adapted to your board's pin naming (e.g. `board.D18` or a specific board pin).
"""
import time
from holidaylights.core import House, HOA, HouseMode
from holidaylights.adapters import CircuitPythonAdapter
...
# Example: leave pin=None so adapter uses default board.D18 if available
leds = CircuitPythonAdapter(NUM_LIGHTS, pin=None)
